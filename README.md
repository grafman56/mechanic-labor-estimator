...
The selector combines `data/lemon-acura-catalog.json` (869 Acura year/model/engine entries) with small, separately tested factory-default records for BMW, Honda, Toyota, Ford, Chevrolet, Hyundai, and Kia. The currently reviewed cross-make records are: 2006 BMW 325Ci Convertible (E46) L6-2.5L (M54); 2006 Honda Accord L4-2.4L; 2008 Honda Civic L4-1.8L; 2010 Toyota Camry L4-2.5L (2AR-FE); 2012 Ford Fusion FWD L4-2.5L; 2012 Chevrolet Malibu L4-2.4L; 2012 Hyundai Sonata L4-2.4L; and 2012 Kia Optima L4-2.4L. The Civic, Sonata, and Optima each had a live Parts and Labor page and an exact published alternator `Replace` row when checked on 2026-07-26: `0.8`, `1.2`, and `1.2` standard hours respectively. A catalog record means `manual available`, not broad estimate or procedure-evidence coverage. Rebuild the Acura catalog with:
